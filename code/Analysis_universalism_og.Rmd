...
```{r}
mod7_GEI<-lmer(uni.z~gndr.c+gei.z.cm+gndr.c:gei.z.cm+
                      essround.c+
                      gndr.c:essround.c+
                      (gndr.c+essround.c+gndr.c:essround.c|cntry),
               data=diff_dat,REML=F,weights = pspwght,
...
```{r}
mod8_GEI<-lmer(uni.z~gndr.c+gei.z.cm+gndr.c:gei.z.cm+
                      essround.c+
                      gndr.c:essround.c+
...
```{r}
mod7_GGGI<-lmer(uni.z~gndr.c+gggi.z.cm+gndr.c:gggi.z.cm+
                      essround.c+
                      gndr.c:essround.c+
                      (gndr.c+essround.c+gndr.c:essround.c|cntry),
               data=diff_dat,REML=F,weights = pspwght,
...
```{r}
mod8_GGGI<-lmer(uni.z~gndr.c+gggi.z.cm+gndr.c:gggi.z.cm+
                      essround.c+
                      gndr.c:essround.c+
...
```{r}
mod7_GDI<-lmer(uni.z~gndr.c+gdi.z.cm+gndr.c:gdi.z.cm+
                      essround.c+
                      gndr.c:essround.c+
                      (gndr.c+essround.c+gndr.c:essround.c|cntry),
               data=diff_dat,REML=F,weights = pspwght,
...
```{r}
mod8_GDI<-lmer(uni.z~gndr.c+gdi.z.cm+gndr.c:gdi.z.cm+
                      essround.c+
                      gndr.c:essround.c+
...
```{r}
mod7_log_GDP<-lmer(uni.z~gndr.c+log_gdp.z.cm+gndr.c:log_gdp.z.cm+
                      essround.c+
                      gndr.c:essround.c+
                      (gndr.c+essround.c+gndr.c:essround.c|cntry),
               data=diff_dat,REML=F,weights = pspwght,
...
```{r}
mod8_log_GDP<-lmer(uni.z~gndr.c+log_gdp.z.cm+gndr.c:log_gdp.z.cm+
                      essround.c+
                      gndr.c:essround.c+
